...
SEED_TICKERS = [
    ...
    {"ticker": "ACLX", "company_name": "Arcellx Inc.", "sector": "Biotech"},
    {"ticker": "ADMA", "company_name": "ADMA Biologics", "sector": "Biotech"},
    {"ticker": "ADPT", "company_name": "Adaptive Biotechnologies", "sector": "Biotech"},
    {"ticker": "ADVM", "company_name": "Adverum Biotechnologies", "sector": "Biotech"},
    {"ticker": "AKRO", "company_name": "Akero Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "AMAM", "company_name": "Ambrx Biopharma", "sector": "Biotech"},
    ...
    {"ticker": "APLS", "company_name": "Apellis Pharmaceuticals", "sector": "Biotech"},
    {"ticker": "APLT", "company_name": "Applied Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "ATHA", "company_name": "Athira Pharma", "sector": "Biotech"},
    ...
    {"ticker": "AVRO", "company_name": "AVROBIO Inc.", "sector": "Biotech"},
    ...
    {"ticker": "BLUE", "company_name": "bluebird bio Inc.", "sector": "Biotech"},
    {"ticker": "BMRN", "company_name": "BioMarin Pharmaceutical", "sector": "Biotech"},
    {"ticker": "BPMC", "company_name": "Blueprint Medicines", "sector": "Biotech"},
    {"ticker": "BTAI", "company_name": "BioXcel Therapeutics", "sector": "Biotech"},
    {"ticker": "CALT", "company_name": "Calliditas Therapeutics", "sector": "Biotech"},
    {"ticker": "CAPR", "company_name": "Capricor Therapeutics", "sector": "Biotech"},
    {"ticker": "CARA", "company_name": "Cara Therapeutics", "sector": "Biotech"},
    {"ticker": "CERE", "company_name": "Cerevel Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "CNTA", "company_name": "Centessa Pharmaceuticals", "sector": "Biotech"},
    {"ticker": "CORT", "company_name": "Corcept Therapeutics", "sector": "Biotech"},
    {"ticker": "CPRX", "company_name": "Catalyst Pharmaceuticals", "sector": "Biotech"},
    ...
    {"ticker": "CVAC", "company_name": "CureVac N.V.", "sector": "Biotech"},
    {"ticker": "CYBN", "company_name": "Cybin Inc.", "sector": "Biotech"},
    {"ticker": "CYTK", "company_name": "Cytokinetics Inc.", "sector": "Biotech"},
    {"ticker": "DAWN", "company_name": "Day One Biopharmaceuticals", "sector": "Biotech"},
    {"ticker": "DCPH", "company_name": "Deciphera Pharmaceuticals", "sector": "Biotech"},
    {"ticker": "DNLI", "company_name": "Denali Therapeutics", "sector": "Biotech"},
    {"ticker": "DNTH", "company_name": "Dianthus Therapeutics", "sector": "Biotech"},
    {"ticker": "DVAX", "company_name": "Dynavax Technologies", "sector": "Biotech"},
    ...
    {"ticker": "ETNB", "company_name": "89bio Inc.", "sector": "Biotech"},
    ...
    {"ticker": "FGEN", "company_name": "FibroGen Inc.", "sector": "Biotech"},
    {"ticker": "FHTX", "company_name": "Foghorn Therapeutics", "sector": "Biotech"},
    {"ticker": "FOLD", "company_name": "Amicus Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "GLPG", "company_name": "Galapagos NV", "sector": "Biotech"},
    {"ticker": "GLYC", "company_name": "GlycoMimetics Inc.", "sector": "Biotech"},
    {"ticker": "GMAB", "company_name": "Genmab A/S", "sector": "Biotech"},
    {"ticker": "GPCR", "company_name": "Structure Therapeutics", "sector": "Biotech"},
    {"ticker": "GRCL", "company_name": "Gracell Biotechnologies", "sector": "Biotech"},
    ...
    {"ticker": "IGMS", "company_name": "IGM Biosciences", "sector": "Biotech"},
    {"ticker": "IKNA", "company_name": "Ikena Oncology", "sector": "Biotech"},
    {"ticker": "IMAB", "company_name": "I-Mab Biopharma", "sector": "Biotech"},
    {"ticker": "IMCR", "company_name": "Immunocore Holdings", "sector": "Biotech"},
    {"ticker": "IMGN", "company_name": "ImmunoGen Inc.", "sector": "Biotech"},
    ...
    {"ticker": "ITOS", "company_name": "iTeos Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "KALV", "company_name": "KalVista Pharmaceuticals", "sector": "Biotech"},
    ...
    {"ticker": "KYVA", "company_name": "Kyverna Therapeutics", "sector": "Biotech"},
    {"ticker": "LBPH", "company_name": "Longboard Pharmaceuticals", "sector": "Biotech"},
    ...
    {"ticker": "MORF", "company_name": "Morphic Holding", "sector": "Biotech"},
    {"ticker": "MRKR", "company_name": "Marker Therapeutics", "sector": "Biotech"},
    {"ticker": "MRNS", "company_name": "Marinus Pharmaceuticals", "sector": "Biotech"},
    {"ticker": "MRSN", "company_name": "Mersana Therapeutics", "sector": "Biotech"},
    {"ticker": "MRTX", "company_name": "Mirati Therapeutics", "sector": "Biotech"},
    {"ticker": "MRNA", "company_name": "Moderna Inc.", "sector": "Biotech"},
    {"ticker": "MURA", "company_name": "Mural Oncology", "sector": "Biotech"},
    ...
    {"ticker": "NVTA", "company_name": "Invitae Corporation", "sector": "Biotech"},
    ...
    {"ticker": "ONCT", "company_name": "Oncternal Therapeutics", "sector": "Biotech"},
    {"ticker": "ONCY", "company_name": "Oncolytics Biotech", "sector": "Biotech"},
    {"ticker": "ONVO", "company_name": "Organovo Holdings", "sector": "Biotech"},
    {"ticker": "OPK", "company_name": "OPKO Health Inc.", "sector": "Biotech"},
    {"ticker": "OPTN", "company_name": "OptiNose Inc.", "sector": "Biotech"},
    ...
    {"ticker": "RAPT", "company_name": "RAPT Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "RGLS", "company_name": "Regulus Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "RPTX", "company_name": "Repare Therapeutics", "sector": "Biotech"},
    {"ticker": "RVMD", "company_name": "Revolution Medicines", "sector": "Biotech"},
    {"ticker": "RVNC", "company_name": "Revance Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "SAGE", "company_name": "Sage Therapeutics", "sector": "Biotech"},
    {"ticker": "SANA", "company_name": "Sana Biotechnology", "sector": "Biotech"},
    {"ticker": "SAVA", "company_name": "Cassava Sciences", "sector": "Biotech"},
    {"ticker": "SCPH", "company_name": "scPharmaceuticals", "sector": "Biotech"},
    {"ticker": "SGEN", "company_name": "Seagen Inc.", "sector": "Biotech"},
    {"ticker": "SGMO", "company_name": "Sangamo Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "SLNO", "company_name": "Soleno Therapeutics", "sector": "Biotech"},
    {"ticker": "SLRN", "company_name": "ACELYRIN Inc.", "sector": "Biotech"},
    ...
    {"ticker": "SWTX", "company_name": "SpringWorks Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "TERN", "company_name": "Terns Pharmaceuticals", "sector": "Biotech"},
    {"ticker": "TGTX", "company_name": "TG Therapeutics", "sector": "Biotech"},
    {"ticker": "TIL", "company_name": "Instil Bio Inc.", "sector": "Biotech"},
    {"ticker": "TMDI", "company_name": "Titan Medical Inc.", "sector": "Biotech"},
    ...
    {"ticker": "TRML", "company_name": "Tourmaline Bio Inc.", "sector": "Biotech"},
    ...
    {"ticker": "UBX", "company_name": "Unity Biotechnology", "sector": "Biotech"},
    ...
    {"ticker": "VERV", "company_name": "Verve Therapeutics", "sector": "Biotech"},
    {"ticker": "VIGL", "company_name": "Vigil Neuroscience", "sector": "Biotech"},
    {"ticker": "VIR", "company_name": "Vir Biotechnology", "sector": "Biotech"},
    {"ticker": "VIRX", "company_name": "Viracta Therapeutics", "sector": "Biotech"},
    ...
    {"ticker": "VRNA", "company_name": "Verona Pharma", "sector": "Biotech"},
    ...
    {"ticker": "VTYX", "company_name": "Ventyx Biosciences", "sector": "Biotech"},
    ...
    {"ticker": "XOMA", "company_name": "XOMA Corporation", "sector": "Biotech"},
    {"ticker": "YMAB", "company_name": "Y-mAbs Therapeutics", "sector": "Biotech"},
